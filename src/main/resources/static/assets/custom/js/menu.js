...
if (usertype == 1) {
    ...
    document.write("<a href='/formMaster'><i class='fa fa-plus-circle' aria-hidden='true'></i>Create Form</a>");
    document.write("</li>");

    document.write("<li class='has-submenu' id='fill_forms'>");
    document.write("<a href='/mstFillForm'><i class='fa fa-file-text-o' aria-hidden='true'></i>Fill Form</a>");
    document.write("</li>");

    document.write("<li class='has-submenu' id='completed_forms'>");
    document.write("<a href='/mstComplateForm'><i class='fa fa-check-circle' aria-hidden='true'></i>Completed Form</a>");
    document.write("</li>");
    ...
    document.write("<ul class='submenu'>");
    document.write("<li><a href='/mstUser' class='subpaddings'>Users</a></li>");
    document.write("</ul>");
    document.write("</li>");
