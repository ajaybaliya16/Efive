var usertype = localStorage.getItem("fullName");
...
document.write("</a>");
document.write("<a href='/logoutt' onclick='javascript:window.localStorage.clear();' id ='logout' class='dropdown-item notify-item border-0'>");
