...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            logger.debug("No Bearer token found in Authorization header, proceeding without authentication");
        ...
        try {
            ...
            logger.debug("Processing JWT for user: {}, role: {}", userEmail, role);
            ...
            if (userEmail != null && authentication == null) {
                ...
                logger.warn("No username extracted from JWT");
                response.sendError(HttpServletResponse.SC_UNAUTHORIZED, 
            ...
            logger.error("Exception in JWT filter for request {}: {}", 
