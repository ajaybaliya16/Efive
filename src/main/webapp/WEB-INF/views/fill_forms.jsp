...
<body class="background-image-body background1 square scrollbar-dusty-grass square thin">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-sm-6 col-xs-12 colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <select class="selectpicker" id="FormDrop" data-style="lineheight12 bg-transfer"
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-sm-6 col-xs-12 mb-0 btntop colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <a
                                                    class="show-details-table btn btn-danger text-white btn-padding ml-1" id='resetbtn'><i
                                    ...
                                    <div class="detailsbg">
                                        <div class="row pr-2 pl-2">
                                            <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding">
                                                <p class="mb-1 font-weight-600"><span id="ansTitle"class="font-weight-700">Form Title:</span>
                                                    <span id="ansTitle" ></span></p>
                
                                                <p class="mb-0 font-weight-600"><span class="font-weight-700">Description:</span>
                                                    <span id="ansDesc">Are all portable fire extinguishers visually inspected every month?At minimum,
                                    ...
                                    <div class="card mb-0 queshadow">
                                        <div class="card-body">
                                            <div class="row pl-2 pr-2 text-center">
                                                <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding">
                                                    <a class="btn btn-success btn-padding mr-2" id="submitFormBtn"><i
	...
	<script src="FillForm/DropDown.js"></script>
	<script src="FillForm/AnswerResponse.js"></script>
